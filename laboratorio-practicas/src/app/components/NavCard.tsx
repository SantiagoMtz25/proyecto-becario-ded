...
const NavCard: React.FC<NavCardProps> = ({num, title, description, path}) => {
  return (
    <>
      <div className="w-80 bg-white shadow-[0px_0px_15px_rgba(0,0,0,0.09)] p-9 space-y-3 relative overflow-hidden">
        ...
        <a href={path} className="text-violet-500 text-sm font-bold">
